export default {
  leaderboard: {
    ...
    page_subtitle: "Поднимитесь на вершину и станьте легендой fitones",
  ...
  premium: {
    ...
    already_premium: "Вы наслаждаетесь fitones Premium",
    no_ads: "Без рекламы",
    upgrade: "Обновить",
    ...
    faq: {
      ...
      subtitle: "Все, что вам нужно знать о fitones и нашей миссии",
      items: [
        {
        ...
        {
          question: "Могу ли я самохостить fitones?",
          answer:
      ...
      additional_support: {
        ...
        community: "Поддержка сообщества (дискорд или hello@fitones)",
    ...
    free_intro_text:
      "fitones — это бесплатное приложение для фитнеса с открытым исходным кодом, которым ежедневно пользуются более 60 000 пользователей. Оно создано с любовью (а не на деньги венчурных фондов ^^) и требует реальных затрат времени и денег для поддержки.",
    ...
    health_upgrade_text: "Если fitones помогает вам улучшить здоровье, пожалуйста, рассмотрите возможность перехода на Премиум :D !",
    ...
    still_unsure: "Все еще не уверены? Не волнуйтесь. fitones всегда останется бесплатным и с открытым исходным кодом.",
  ...
  release_notes: {
    ...
    notes: {
      ...
      note_2025_06_19: {
        ...
        content:
          "fitones v1.2 теперь является прогрессивным веб-приложением! Установите его на ваш телефон для получения нативного опыта приложения с офлайн доступом. 🚀",
      },
      note_2025_06_18: {
        title:
        ...
        content:
          "fitones достиг первого места на Hacker News! Спасибо всем за потрясающую поддержку и добро пожаловать всем новым пользователям! 💪",
      },
      note_2025_06_01: {
  ...
  // Premium Upsell Alert
    title: "Разблокируйте расширенные функции с fitones Premium",
    or: "или",
  },
  ...
  commons: {
    ...
    discover_workoutcool: "Откройте fitones",
