...
fitones nasceu do desejo de oferecer uma plataforma de treino confiável, moderna e ativamente mantida, após o projeto original <WorkoutLol variant="muted" /> ter sido abandonado.

## A história

fitones é o resultado de uma aventura impulsionada pela comunidade.
...
fitones é open source, garantindo transparência, modularidade e escalabilidade.
Todos são bem-vindos para contribuir com código, documentação ou ideias!

- [Ver o projeto no GitHub](https://github.com/Snouzy/fitones)
